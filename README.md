...
配套的 VS Code 风格 C++ IDE: [dk-lang-ide](https://github.com/dk-lang/dk-lang-ide)

- ActivityBar | SideBar | Editor (Minimap) | Terminal | StatusBar
- DK-Lang 语法高亮 (8 色)
- Dark+ / Light+ 主题
- 快捷键: Ctrl+N/O/S/W/B/`/F5/Shift+E
